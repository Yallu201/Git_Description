...
1. 설정과 초기화 - [바로가기](#section1)
1. 기본적인 사용법 - [바로가기](#section2)
1. 브랜치 - [바로가기](#section3)
1. Git 이력 - [바로가기](#section4)
1. 원격저장소 - [바로가기](#section5)

## 1. 설정과 초기화<a name="section1"></a>
...
#### 브랜치 삭제하기
    ...
    1. 삭제할 브랜치가 현재 브랜치에 합쳐졌을 경우에만
    git branch -d <삭제할 브랜치>

    2. 삭제할 브랜치가 현재 브랜치에 합쳐지지 않았어도
    git branch -D <삭제할 브랜치>

## 4. Git 이력<a name="section4"></a>
